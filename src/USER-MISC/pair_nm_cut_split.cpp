...
PairNMCutSplit::PairNMCutSplit(LAMMPS *lmp) : Pair(lmp)
{
  writedata = 1;
}
...
void PairNMCutSplit::settings(int narg, char **arg)
{
...
void PairNMCutSplit::coeff(int narg, char **arg)
{
  if (narg < 6 || narg > 7)
...
double PairNMCutSplit::init_one(int i, int j)
{
...
void PairNMCutSplit::write_restart(FILE *fp)
{
...
void PairNMCutSplit::read_restart(FILE *fp)
{
...
void PairNMCutSplit::write_restart_settings(FILE *fp)
{
...
void PairNMCutSplit::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
void PairNMCutSplit::write_data(FILE *fp)
{
...
void PairNMCutSplit::write_data_all(FILE *fp)
{
  for (int i = 1; i <= atom->ntypes; i++)
...
void *PairNMCutSplit::extract(const char *str, int &dim)
{
  dim = 2;
